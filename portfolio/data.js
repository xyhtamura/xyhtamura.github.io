...
// --------------------------------------------------
  ...
  },
  {
    ...
    piece: {
      ...
      media: [
        { type: "image", src: "../img/unboundedorgan1.png", label: "The Unbounded Organ interface showing pipe length controls, harmonic modes, and reference lengths" },
        { type: "image", src: "../img/unboundedorgan2.png", label: "The Unbounded Organ explainer showing the invariant waveguide recursion and 1D wave equation" }
      ],
  ...
  },
{
  ...
  },
  {
    ...
    pieces: [
	{
	  ...
	  blurb: "A WebGL video synthesiser driven by a live 2D fluid and magnetohydrodynamic simulation. Its velocity field warps procedural colour fields, uploaded media, or camera input across five solver regimes—including Navier–Stokes, viscoelastic shear, and induction-driven magnetic current sheets—under interactive touch and multi-band audio control. Includes Ganymede, a WebGL image-warping tool with animated noise fields, lens distortion, and audio reactivity.",
	  links: [
