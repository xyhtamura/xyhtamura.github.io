...
| 2 | *(prime meridian / critical horology)* | concept | Greenwich as imposed zero; longitude as empire's grid; clock discipline |
...
Two of five built. Both byte-legal. Neither has been W3C-validated or renamed for the
zip yet — that's the pre-submission pass (§6 step 6), do it for all pieces at once near
the deadline.
