...
const workLinks = {
  ...
  "a landline imagining a line probe during a storm": [
    ["Open project", "https://xyhtamura.github.io/landline/"]
  ],
  "Hauntotechnics · Critterances": [
    ["Hauntotechnics essay", "https://xyhtamura.github.io/"],
    ["Critterances", "https://xyhtamura.github.io/critterances/"]
  ],
  "Hauntotechnics": [
    ["Read essay", "https://xyhtamura.github.io/"]
  ],
  "Critterances": [
    ["Open work", "https://xyhtamura.github.io/critterances/"]
  ]
};
...
function setActive(index, updateHash = true) {
  ...
  currentTitle.textContent = heading ? headingName(heading) : "Vestigia";
